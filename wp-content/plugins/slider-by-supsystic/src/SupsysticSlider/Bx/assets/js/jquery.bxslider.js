...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var init = function(){
			...
			slider.settings.auto = slider.settings.auto == 'enable';
			slider.settings.slideshowControls = slider.settings.slideshowControls == 'enable';
		...
		var setup = function(){
			...
			if(!slider.settings.ticker){
				...
				if(!slider.settings.auto && slider.settings.slideshowControls) appendControlsAuto();
		...
		var appendCaptions = function(){
			...
			slider.children.each(function(index){
				...
				,	title = image.length ? image.data('title') : $(this).attr('data-title');
				// append the caption
				if (title != undefined && ('' + title).length) {
					var captionPosition = slider.settings.inTop == true ? 'top' : '';

					$(this).append('<div class="bx-caption ' + captionPosition + '"><span class="caption"></span></div>');
